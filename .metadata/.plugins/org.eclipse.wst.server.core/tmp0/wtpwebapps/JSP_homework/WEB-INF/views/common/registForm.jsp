...
<html>
	...
	<body>
		<form name="form" action="regist" method="post"
			class="table table-border">
			<div class="constr">
				<div class="regist-head">가입</div>
				<div class="regist-body">
					<div class="regist-main">
						...
						<div class="regist-group">
							<label class="regist-label">전화번호</label>
							<div class="regist-cell">
								<input type="text" name="phone" class="regist-input">
							</div>
						</div>
	
						<div class="regist-group">
							<div>
								<input type="button" value="회원가입" class="regist-btn">
							</div>
						</div>
		...
		<script type="text/javascript">
			document.querySelector('form[action="regist"] input[type="button"]').onclick=function(event){
