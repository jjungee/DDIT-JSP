				 ...
				 <div class="card-body login-card-body">
					...
					<form action="<%=request.getContextPath() %>/common/login.do"	method="post">
						...
						<div class="row">
							...
							<!-- /.col -->
							<div class="col-sm-4">
								<button type="submit" class="btn btn-block btn-outline-primary mt-2">로그인</button>
							</div>
							<!-- /.col -->
						</div>
					</form>
					<a href="<%= request.getContextPath() %>/member/registForm.do" style="font-weight:bold;">회원가입</a><br> 
