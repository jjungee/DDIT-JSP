...
<title>vac regist</title>

<body>
	<!-- Content Wrapper. Contains page content -->
  
	<!-- Main content -->
	<section class="content register-page" style="height:130vh;">
		<div class="register-box">
			<div class="login-logo">
    			<a href="<%=request.getContextPath()%>/member/registForm.do"><b>회원 가입</b></a>
  			</div>
			<!-- form start -->
			<div class="card">				
					...
					<form role="form" class="form-horizontal" action="regist.do" method="post">						
						...
						<div class="input-group mb-3">
							<div class="mailbox-attachments clearfix" style="text-align: center;">
								...
								<div class="mailbox-attachment-info">
									<div class="input-group input-group-sm">
										<label for="inputFile" class="btn btn-outline-info btn-sm input-group-addon">파일선택</label>
										<input id="inputFileName" class="form-control" type="text" name="tempPicture" disabled/>
										<input id="picture" class="form-control" type="hidden" name="picture" />
										<span class="input-group-append-sm">											
											<button type="button" class="btn btn-block btn-info btn-sm" onclick="upload_go();">업로드</button>											
										</span>
									</div>
								</div>
							</div>
						  ...
						  <div class="form-group row">
							...
							<div class="col-sm-9 input-group input-group-sm">
								...
								<span class="input-group-append-sm">	
									<button type="button" onclick="idCheck_go();"  class="btn btn-block btn-info btn-sm">중복확인</button>
								</span>								
							</div>								
						</div>
						<div class="form-group row">
						...
						<div class="card-footer">
							<div class="row text-center">								
								<div class="col-sm-6">
									<button type="button" id="registBtn" onclick="submit_go();" class="btn btn-block btn-info btn-sm">가입하기</button>
							 	</div>
							 	<div class="col-sm-6">
							 		<a href="<%=request.getContextPath()%>/">
										<button type="button" id="cancelBtn"
											class="btn btn-block btn-danger btn-sm">&nbsp;&nbsp;&nbsp;취 &nbsp;&nbsp;소&nbsp;&nbsp;&nbsp;</button>
									</a>
								</div>
							</div>
						</div>
